...
`intellij-rascal-bundle/` and makes sure nothing else (a stray
...
`intellij-rascal-bundle/` is derived from
...
`intellij-rascal-bundle/syntaxes/rascal.tmLanguage.json` directly
